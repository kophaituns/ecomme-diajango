...
urlpatterns = [
    ...
    # AI feature URLs
    path('ai-chatbot/', views.ai_chatbot_view, name='ai-chatbot'),
    path('ai-chat-api/', views.ai_chat_api, name='ai-chat-api'),
    path('ai-recommendations/', views.ai_recommendations_view, name='ai-recommendations'),
    path('ai-analyze-feedback/<int:pk>/', views.ai_analyze_feedback_view, name='ai-analyze-feedback'),
